...
static const u8 sSpeciesToBackAnimSet[] =
{
    ...
    [SPECIES_FRONDLET]   = BACK_ANIM_TRIANGLE_DOWN,

    [SPECIES_GROTLE - 1] = BACK_ANIM_H_SLIDE,
    [SPECIES_TORTERRA - 1] = BACK_ANIM_SHAKE_GLOW_GREEN,
    [SPECIES_CHIMCHAR - 1] = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_MONFERNO - 1] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_INFERNAPE - 1] = BACK_ANIM_SHAKE_GLOW_RED,
    [SPECIES_PIPLUP - 1] = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_PRINPLUP - 1] = BACK_ANIM_V_STRETCH,
    [SPECIES_EMPOLEON - 1] = BACK_ANIM_SHAKE_GLOW_BLUE,
    [SPECIES_STARLY - 1] = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_STARAVIA - 1] = BACK_ANIM_TRIANGLE_DOWN,
    [SPECIES_STARAPTOR - 1] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_BIDOOF - 1] = BACK_ANIM_V_SHAKE_H_SLIDE,
    [SPECIES_BIBAREL - 1] = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_KRICKETOT - 1] = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_KRICKETUNE - 1] = BACK_ANIM_H_VIBRATE,
    [SPECIES_SHINX - 1] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_LUXIO - 1] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_LUXRAY - 1] = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_CRANIDOS - 1] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_RAMPARDOS - 1] = BACK_ANIM_V_SHAKE_LOW,
    [SPECIES_SHIELDON - 1] = BACK_ANIM_V_SHAKE,
    [SPECIES_BASTIODON - 1] = BACK_ANIM_V_SHAKE_LOW,
    [SPECIES_BURMY - 1] = BACK_ANIM_H_SHAKE,
    [SPECIES_WORMADAM - 1] = BACK_ANIM_V_SHAKE,
    [SPECIES_MOTHIM - 1] = BACK_ANIM_H_SHAKE,
    [SPECIES_COMBEE - 1] = BACK_ANIM_TRIANGLE_DOWN,
    [SPECIES_VESPIQUEN - 1] = BACK_ANIM_CIRCLE_COUNTERCLOCKWISE,
    [SPECIES_PACHIRISU - 1] = BACK_ANIM_SHAKE_FLASH_YELLOW,
    [SPECIES_BUIZEL - 1] = BACK_ANIM_H_SLIDE,
    [SPECIES_FLOATZEL - 1] = BACK_ANIM_V_STRETCH,
    [SPECIES_CHERUBI - 1] = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_CHERRIM - 1] = BACK_ANIM_V_STRETCH,
    [SPECIES_SHELLOS - 1] = BACK_ANIM_H_SPRING,
    [SPECIES_GASTRODON - 1] = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_DRIFLOON - 1] = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_DRIFBLIM - 1] = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_BUNEARY - 1] = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_LOPUNNY - 1] = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_GLAMEOW - 1] = BACK_ANIM_SHRINK_GROW,
    [SPECIES_PURUGLY - 1] = BACK_ANIM_GROW_STUTTER,
    [SPECIES_STUNKY - 1] = BACK_ANIM_H_SLIDE,
    [SPECIES_SKUNTANK - 1] = BACK_ANIM_H_STRETCH,
    [SPECIES_BRONZOR - 1] = BACK_ANIM_TRIANGLE_DOWN,
    [SPECIES_BRONZONG - 1] = BACK_ANIM_V_SHAKE_LOW,
    [SPECIES_CHATOT - 1] = BACK_ANIM_V_STRETCH,
    [SPECIES_SPIRITOMB - 1] = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_GIBLE - 1] = BACK_ANIM_H_SHAKE,
    [SPECIES_GABITE - 1] = BACK_ANIM_V_SHAKE,
    [SPECIES_GARCHOMP - 1] = BACK_ANIM_V_SHAKE_LOW,
    [SPECIES_RIOLU - 1] = BACK_ANIM_CONCAVE_ARC_LARGE,
    [SPECIES_LUCARIO - 1] = BACK_ANIM_V_SHAKE_H_SLIDE,
    [SPECIES_HIPPOPOTAS - 1] = BACK_ANIM_H_SLIDE,
    [SPECIES_HIPPOWDON - 1] = BACK_ANIM_V_SHAKE_LOW,
    [SPECIES_SKORUPI - 1] = BACK_ANIM_H_SLIDE,
    [SPECIES_DRAPION - 1] = BACK_ANIM_V_SHAKE_H_SLIDE,
    [SPECIES_CROAGUNK - 1] = BACK_ANIM_GROW,
    [SPECIES_TOXICROAK - 1] = BACK_ANIM_V_SHAKE_H_SLIDE,
    [SPECIES_CARNIVINE - 1] = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_FINNEON - 1] = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_LUMINEON - 1] = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_SNOVER - 1] = BACK_ANIM_V_STRETCH,
    [SPECIES_ABOMASNOW - 1] = BACK_ANIM_V_SHAKE_LOW,
    [SPECIES_UXIE - 1] = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_MESPRIT - 1] = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_AZELF - 1] = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_DIALGA - 1] = BACK_ANIM_V_SHAKE,
    [SPECIES_PALKIA - 1] = BACK_ANIM_H_SHAKE,
    [SPECIES_HEATRAN - 1] = BACK_ANIM_SHAKE_GLOW_RED,
    [SPECIES_REGIGIGAS - 1] = BACK_ANIM_V_SHAKE_LOW,
    [SPECIES_GIRATINA - 1] = BACK_ANIM_V_SHAKE_LOW,
    [SPECIES_CRESSELIA - 1] = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_PHIONE - 1] = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_MANAPHY - 1] = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_DARKRAI - 1] = BACK_ANIM_SHRINK_GROW_VIBRATE,
};
