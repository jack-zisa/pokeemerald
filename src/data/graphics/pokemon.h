...
const u32 gMonStillFrontPic_Frondlet[] = INCBIN_U32("graphics/pokemon/frondlet/front.4bpp.lz");
const u32 gMonPalette_Frondlet[] = INCBIN_U32("graphics/pokemon/frondlet/normal.gbapal.lz");
const u32 gMonBackPic_Frondlet[] = INCBIN_U32("graphics/pokemon/frondlet/back.4bpp.lz");
const u32 gMonShinyPalette_Frondlet[] = INCBIN_U32("graphics/pokemon/frondlet/shiny.gbapal.lz");
const u8 gMonIcon_Frondlet[] = INCBIN_U8("graphics/pokemon/frondlet/icon.4bpp");
const u8 gMonFootprint_Frondlet[] = INCBIN_U8("graphics/pokemon/frondlet/footprint.1bpp");
