const struct PokedexEntry gPokedexEntries[] =
{
    ...
    [NATIONAL_DEX_FRONDLET] =
    {
        .categoryName = _("PALM FROND"),
        .height = 4,
        .weight = 28,
        .description = gFrondletPokedexText,
        .pokemonScale = 508,
        .pokemonOffset = -3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_BURMY] =
    {
        ...
        .height = 2,
        .weight = 34,
        .description = gBurmy_plant_cloakPokedexText,
        .pokemonScale = 682,
        .pokemonOffset = 24,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_WORMADAM] =
    {
        ...
        .height = 5,
        .weight = 65,
        .description = gWormadam_plant_cloakPokedexText,
        .pokemonScale = 432,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_CHERRIM] =
    {
        ...
        .height = 5,
        .weight = 93,
        .description = gCherrim_overcastPokedexText,
        .pokemonScale = 432,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_SHELLOS] =
    {
        ...
        .height = 3,
        .weight = 63,
        .description = gShellos_west_seaPokedexText,
        .pokemonScale = 530,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_GASTRODON] =
    {
        ...
        .height = 9,
        .weight = 299,
        .description = gGastrodon_west_seaPokedexText,
        .pokemonScale = 338,
        .pokemonOffset = 8,
        .trainerScale = 256,
        .trainerOffset = 0,
